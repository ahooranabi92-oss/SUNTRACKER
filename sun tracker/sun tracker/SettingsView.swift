        ...
        NavigationStack {
            List {
                ...
                Section(header: Text("Support")) {
                    ...
                    SettingsRow(iconName: "message", title: "Feedback", detail: nil)
                    
                 
                    SettingsRow(iconName: "questionmark.circle", title: "Help", detail: nil)
                    
                    SettingsRow(iconName: "star", title: "Rate App", detail: nil)
                                    }
                SettingsRow(iconName: "list.bullent.ident", title: "Terms", detail: nil)
            }
